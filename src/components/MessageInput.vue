...
<template>
 <div class="sm:rounded-xl sm:shadow-lg p-1 sm:p-4 bg-white flex gap-2 flex-col w-screen sm:w-min border-b border-grey-500 sm:border-none">
     <form @submit.prevent="sendTransaction" class="flex gap-8">
        <input type="text" v-model="messageComputed" class="border-gray-400 border rounded-xl sm:px-4 px-1" />
